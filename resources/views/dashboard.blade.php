...
<head>
    ...
    <style>
        :root {
            --bg: #0b0e13; --surface: #111620; --surface-2: #181d28;
            --border: #1e2535; --border-lit: #2a3448;
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-box { background: var(--surface); border: 1px solid var(--border-lit); border-radius: 16px; padding: 28px; }
        .badge-on  { background: #052e16; color: #86efac; border: 1px solid #14532d; padding: 4px 12px; border-radius: 20px; }
        .badge-off { background: #450a0a; color: #fca5a5; border: 1px solid #7f1d1d; padding: 4px 12px; border-radius: 20px; }
        .toast-msg { position: fixed; bottom: 24px; right: 24px; background: var(--surface); border: 1px solid var(--border-lit); border-radius: 12px; padding: 14px 20px; z-index: 9999; display: none; box-shadow: 0 10px 30px rgba(0,0,0,0.6); }
            ...
            <div class="card-box">
                ...
                <div class="d-flex justify-content-between align-items-center py-3 border-bottom">
                    ...
                    <label class="form-check form-switch">
                        <input type="checkbox" class="form-check-input" id="twoFaToggle" onchange="toggle2FA(this)" style="transform:scale(1.4);">
                    </label>
                </div>
...
async function loadUser() {
    try {
        ...
        console.error(e);
        document.getElementById('heroSub').innerHTML = '<span class="text-danger">Failed to load profile</span>';
    }
}
